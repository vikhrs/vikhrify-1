...
app.post('/api/posts', async (req, res) => {
    ...
    db.posts.push({ id: Date.now(), userId, content, username: u.username, name: u.name, avatar: u.avatar });
...
app.listen(PORT, () => console.log('Vikhrify Engine Active on port ' + PORT));
